...
def main():
    parser = argparse.ArgumentParser(description="Debug C++ code using Gemini 2.5 Pro.")
    ...
    checkpoint_file = "Gemini-2.5-Pro_cpp_checkpoint.json"
    output_file = "Gemini-2.5-Pro_cpp_results.json"
