...
def main():
    parser = argparse.ArgumentParser(description="Debug Java code using Gemini 2.5 Pro.")
    ...
    checkpoint_file = "Gemini-2.5-Pro_java_checkpoint.json"
    output_file = "Gemini-2.5-Pro_java_results.json"
