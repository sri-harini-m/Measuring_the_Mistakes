...
def main():
    parser = argparse.ArgumentParser(description="Debug Python code using Claude Sonnet 4.5.")
    ...
    checkpoint_file = "Claude-Sonnet-4.5_python3_checkpoint.json"
    output_file = "Claude-Sonnet-4.5_python3_results.json"
